...
# Load game history
history = pd.read_csv("Markov_history.csv").to_dict(orient="records")
...
# Hàm dự đoán nước đi tiếp theo dựa trên Markov Chain
...
def save_history_to_csv(history, filename="Markov_history.csv"):
            ...
            if timer > 3:
                ...
                if hands:
                    ...
                    if fingers == [0, 0, 0, 0, 0]:
                        playerMove = 1  # Nắm tay: Búa
                    elif fingers == [1, 1, 1, 1, 1]:
                        playerMove = 2  # Xòe tay: Bao
                    elif fingers == [0, 1, 1, 0, 0]:
                        playerMove = 3  # Hai ngón: Kéo
